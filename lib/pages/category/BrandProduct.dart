    ...
    Widget buildItems = ListenableProvider.value(
      ...
      child: Consumer<ProductProvider>(builder: (context, value, child) {
        ...
        if (value.listBrandProduct.isEmpty) {
          return buildSearchEmpty(context,AppLocalizations.of(context).translate( "Can't find the products"));
        }
        return Expanded(
          child: GridView.builder(
                                ...
                                RichText(
                                  text: TextSpan(
                                    ...
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: productDetail
                                                  .productRegPrice.toString()+" "+AppLocalizations.of(context).translate("EGP"),
                                          style: TextStyle(
                                              decoration:
                        ...
                        productDetail.type == 'simple'
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(
                                  text:
                                          productDetail.productPrice.toString()+" "+AppLocalizations.of(context).translate("EGP"),
                                  style: TextStyle(
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              productDetail.variationPrices.isEmpty
                                  ? TextSpan(
                                  text: productDetail.productRegPrice.toString()+" "+AppLocalizations.of(context).translate("EGP"),                                  style: TextStyle(
                                      fontWeight: FontWeight.w600,
                                      fontSize: responsiveFont(11),
                                      color: secondaryColor))
                                  : TextSpan(
                                  text: productDetail.variationPrices
                                      ...
                                      ? '${productDetail.variationPrices.first.toString()+" "+AppLocalizations.of(context).translate("EGP")}'
                      : '${productDetail.variationPrices.first}'.toString()+ "-" +'${productDetail.variationPrices.last}'.toString()+AppLocalizations.of(context).translate("EGP"),
                                  style: TextStyle(
                                      fontWeight: FontWeight.w600,
                                      fontSize: responsiveFont(11),
                                      color: secondaryColor)),
