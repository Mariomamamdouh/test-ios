                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(fontSize: responsiveFont(9),color: Colors.grey[600]),
                    ),
                    Visibility(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(productCart[index].cartQuantity.toString(),style: TextStyle(color: Colors.grey[700]),),
                              SizedBox(
                                width: 10,
                              ),
                              Container(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          coupons.couponUsed == null
                              ...
                              child: Text(
                                "${AppLocalizations.of(context).translate('discount')} : ${coupons.couponUsed.amount}",
                                style:
